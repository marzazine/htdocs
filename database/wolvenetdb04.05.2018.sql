...
--
-- Hôte : 127.0.0.1
-- Généré le :  ven. 04 mai 2018 à 22:31
...
(2, 'AEG', 'Eclipse 10', 'Noir', 'aeg-eclipse-10', 'DECT sans fil', '49.99', 2013, 'L\'Eclipse se démarque de tous les autres téléphones DECT par son allure singulière et unique. Sa forme tout arrondie et le mélange des couleurs flashy le rendent unique.<br />\r\n\r\nNéanmoins, son prix le positionne dans la catégorie haut de gamme et le soin accordé aux matériaux fait défaut.<br />\r\n\r\nDe plus, ne cherchez pas les dernières technologies que l\'on retrouve sur d\'autres modèles haut de gamme (synchronisation via Bluetooth), l\'Eclipse mise avant tout sur l\'apparence. ', '2 ans', NULL, 'Écran : 34 x 24 mm', 'img/fixes/aegeclipse10/transparent.png', NULL, NULL),
(3, 'Gigaset', 'A250', 'Noir', 'gigaset-a250', 'DECT sans fil', '34.99', 2016, '<ul>\r\n  <li>Téléphone sans fil système de répondeur</li>\r\n\r\n  <li>Capacité répertoire : 20 noms et numéros</li>\r\n\r\n  <li>Touche répertoire, touche commutateur, bouton de recomposition automatique</li>\r\n\r\n  <li>Minuteur d\'appels, horloge intégrée, horodateur</li>\r\n\r\n  <li>Portée maximale : 50 m</li>\r\n\r\n  <li>Autonomie en communication : Jusqu\'à 780 minutes</li>\r\n\r\n</ul>', '2 ans', '120g', '10.2cm x 11.5cm x 10.5cm', 'img/fixes/gigaseta250/transparent1.png', NULL, NULL);
