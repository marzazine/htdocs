...
--
-- Hôte : 127.0.0.1
-- Généré le :  mer. 02 mai 2018 à 14:43
...
INSERT INTO `fixes` (`id`, `marqueFixe`, `modeleFixe`, `refFixe`, `prixbaseFixe`, `anneeFixe`, `descFixe`, `garantieFixe`, `poidsFixe`, `dimenFixe`, `urlimgminiFixe`) VALUES
(1, 'AEG', 'Loop', 'aeg-loop', '29.99', 2017, 'Le  téléphone sans fil AEG LOOP  se démarque par son design intemporel, son écran rétroéclairé et son haut parleur de haute qualité.<br>\r\nCe téléphone  DECT se veut simple à utiliser et original.<br />\r\n\r\n<strong>Un look intemporel</strong>\r\nSon design futuriste est original et adapté à la forme du visage. Votre confort d\'utilisation est ainsi renforcé.  Son écran LCD à rétro éclairage bleu renforce son allure moderne et pratique.  <br /><br />\r\n', '5 ans', '500g', '250x395x205', NULL),
(2, 'AEG', 'Eclipse 10', 'aeg-eclipse10', '54.99', 2017, 'Ce téléphone fixe au design atypique et sans fil sera répondre aux demandes les plus exigeante. \r\nDe part sa fonctionnalité sans fils parler au téléphone dans toute votre maison. Vous serez en mesure d\'enregistrer plus de 100 numéro dans votre répertoire. Enfin ce téléphone possède une autonomie de 780 minutes. ', '5 ans', '450g', '250x312x402', NULL),
(3, 'Gigaset', 'A250', 'gigaseta250', '34.99', 2016, 'Un téléphone fixe classique en combiné, vous pourrez faire jusqu\'à 80 contacts. Vous pourrez profité de ce fixe longtemps grâce à ses 1080 minutes d\'autonomie !  ', '1 ans', '350gx2', '168x160x210', NULL);
