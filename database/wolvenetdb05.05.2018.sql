...
--
-- Hôte : 127.0.0.1
-- Généré le :  sam. 05 mai 2018 à 18:20
...
CREATE TABLE IF NOT EXISTS `catalogue` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` set('Mobile','Fixe','Box','Offre','Forfait','Accessoire') COLLATE utf8_bin DEFAULT NULL,
  `marque` char(255) COLLATE utf8_bin DEFAULT NULL,
  `modele` char(255) COLLATE utf8_bin DEFAULT NULL,
  `couleur` char(255) COLLATE utf8_bin DEFAULT NULL,
  `capacite` char(255) COLLATE utf8_bin DEFAULT NULL,
  `reference` char(255) COLLATE utf8_bin DEFAULT NULL,
  `prixbase` float NOT NULL DEFAULT '0',
  `annee` year(4) DEFAULT NULL,
  `description` text COLLATE utf8_bin,
  `garantie` char(6) COLLATE utf8_bin DEFAULT NULL,
  `poids` char(255) COLLATE utf8_bin DEFAULT NULL,
  `dimensions` char(255) COLLATE utf8_bin DEFAULT NULL,
  `options` text COLLATE utf8_bin,
  `enpromo` tinyint(1) NOT NULL DEFAULT '0',
  `url1slide` char(255) COLLATE utf8_bin DEFAULT NULL,
  `url2slide` char(255) COLLATE utf8_bin DEFAULT NULL,
  `url3slide` char(255) COLLATE utf8_bin DEFAULT NULL,
  `url4slide` char(255) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

--
-- RELATIONS POUR LA TABLE `catalogue`:
--
...
INSERT INTO `catalogue` (`id`, `type`, `marque`, `modele`, `couleur`, `capacite`, `reference`, `prixbase`, `annee`, `description`, `garantie`, `poids`, `dimensions`, `options`, `enpromo`, `url1slide`, `url2slide`, `url3slide`, `url4slide`) VALUES
(29, 'Accessoire', 'Apple', 'Ensemble Adaptateur secteur USB 5 W Apple + Cable USB-C (1m) vers Lightning', 'Blanc', NULL, 'ensemble-lightning-basique', 19.99, 2018, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL),
(30, 'Accessoire', 'Samsung', 'Chargeur USB-C', 'Noir', NULL, 'chargeur-usb-c-samsung', 14.99, 2018, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL),
(31, 'Accessoire', 'Samsung', 'Chargeur USB', 'Noir', NULL, 'chargeur-usb-samsung', 14.99, 2018, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL),
(32, 'Accessoire', 'JBL', 'Go', 'Noir', NULL, 'jbl-go', 29.99, 2018, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL),
(33, 'Accessoire', 'Apple', 'AirPods sans fil', 'Blanc', NULL, 'apple-airpods', 179.99, 2018, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL),
(34, 'Accessoire', 'Apple', 'EarPods', 'Blanc', NULL, 'apple-earpods', 19.99, 2018, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL),
(35, 'Accessoire', 'Samsung', 'Kit mains libres', 'Noir', NULL, 'samsung-kit-mains-libres', 9.99, 2018, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL),
(36, 'Fixe', 'AEG', 'Eclipse 10', 'Blanc', NULL, 'aeg-eclipse-10-blanc', 49.99, 2017, 'Le  téléphone sans fil AEG LOOP  se démarque par son design intemporel, son écran rétroéclairé et son haut parleur de haute qualité.<br>\r\nCe téléphone  DECT se veut simple à utiliser et original.<br /><br />\r\n\r\n<strong>Un look intemporel</strong><br />\r\nSon design futuriste est original et adapté à la forme du visage. Votre confort d\'utilisation est ainsi renforcé.  Son écran LCD à rétro éclairage bleu renforce son allure moderne et pratique.\r\n', '5 ans', '500g', '250 x 395 x 205', NULL, 0, NULL, NULL, NULL, NULL),
(37, 'Fixe', 'Gigaset', 'A250', 'Noir', NULL, 'gigaset-a250', 34.99, 2016, '<ul>\r\n  <li>Téléphone sans fil système de répondeur</li>\r\n\r\n  <li>Capacité répertoire : 20 noms et numéros</li>\r\n\r\n  <li>Touche répertoire, touche commutateur, bouton de recomposition automatique</li>\r\n\r\n  <li>Minuteur d\'appels, horloge intégrée, horodateur</li>\r\n\r\n  <li>Portée maximale : 50 m</li>\r\n\r\n  <li>Autonomie en communication : Jusqu\'à 780 minutes</li>\r\n\r\n</ul>', '2 ans', '120g', '10.2cm x 11.5cm x 10.5cm', NULL, 0, NULL, NULL, NULL, NULL),
(38, 'Fixe', 'AEG', 'Loop', 'Blanc', NULL, 'aeg-loop', 29.99, 2017, 'Le  téléphone sans fil AEG LOOP  se démarque par son design intemporel, son écran rétroéclairé et son haut parleur de haute qualité.<br>\r\nCe téléphone  DECT se veut simple à utiliser et original.<br /><br />\r\n\r\n<strong>Un look intemporel</strong><br />\r\nSon design futuriste est original et adapté à la forme du visage. Votre confort d\'utilisation est ainsi renforcé.  Son écran LCD à rétro éclairage bleu renforce son allure moderne et pratique.\r\n', '5 ans', '500g', '250x395x205', NULL, 0, NULL, NULL, NULL, NULL);
